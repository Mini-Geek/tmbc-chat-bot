...
// Source: https://raw.githubusercontent.com/insa-frif/typed-facebook-chat-api/1bfa716b7e263212d755af20fe21a648b72b609b/index.d.ts
 ...
 */
function FacebookChatApi(credentials: FacebookChatApi.Credentials | FacebookChatApi.AppStateContainer, callback?: (err: FacebookChatApi.ErrorObject, api: FacebookChatApi.Api) => any): void;
function FacebookChatApi (credentials: FacebookChatApi.Credentials | FacebookChatApi.AppStateContainer, options: FacebookChatApi.ApiOptions, callback?: (err: FacebookChatApi.ErrorObject, api: FacebookChatApi.Api) => any): void;
...
namespace FacebookChatApi {
  ...
  export interface Api {
    ...
    searchForMessages(query: string, threadID: InputID, isGroup: boolean, callback: (err: ErrorObject, snippets: Snippet[]) => any): void;
